...
|------------------------------------------|------------------------------|--------------------|----------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Logo                                     | Cobalt Blue #0D47A1          | blue darken-4      | <p style="color: #0D47A1;">#0D47A1</p> | Logo.                                                                                                                                                                                        |
| Primary and  Background Colour (reverse) | Cobalt Blue #0D47A1          | blue darken-4      | <p style="color: #0D47A1;">#0D47A1</p> | Together with white and black in some cases - button and navigation bar background, secondary button text over white background, active form field icons and labels, links, active elements. |
| Secondary and Font Colour (reverse)      | White #FFFFFF                | white              | <p style="color: #FFFFFF;">#FFFFFF</p> | Together with blue - button and navigation bar text and icons, secondary button background over blue background.                                                                             |
| Tertiary Colour                          | Dark Cornflower Blue #0C4091 | no equivalent      | <p style="color: #0C4091;">#0C4091</p> | Toggle switch on, background colour.                                                                                                                                                         |
| Quaternary Colour                        | Black #000000                | black              | <p style="color: #000000;">#000000</p> | Most text is black, form field, book details, and table text.                                                                                                                                |
| Accent Colour 1                          | Ruby #D81B60                 | pink darken-1      | <p style="color: #D81B60;">#D81B60</p> | Flash message failure, delete book, delete user.                                                                                                                                             |
| Accent Colour 2                          | Persian Green #26A69A        | teal lighten-1     | <p style="color: #26A69A;">#26A69A</p> | Flash message success, view book.                                                                                                                                                            |
